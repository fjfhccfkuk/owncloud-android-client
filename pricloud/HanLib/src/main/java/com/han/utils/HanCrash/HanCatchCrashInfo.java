...
public class HanCatchCrashInfo implements Thread.UncaughtExceptionHandler, HanExcpCatcher {
    private static HanCatchCrashInfo mCCI = null;
    private static ICreashInfo mGather = null;
    private static String verName = null;

    private static class CatchCreashInner {
        private static Context mCtx = null;
        private static HanCatchCrashInfo mCrashInfo = new HanCatchCrashInfo();
        private static Thread.UncaughtExceptionHandler mDefCrashHandler = Thread.getDefaultUncaughtExceptionHandler();
    }

    public static HanExcpCatcher ConstructInstance(Context c) {
        if (null == mCCI) {
